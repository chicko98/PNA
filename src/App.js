...
var questions = [
  ...
  {
    questionText: "Uma mulher de 51 anos, secretária numa administração hospitalar, sedentária,"+
...
"FRAX a 10 anos com probabilidade de fratura da anca ÷ 0,9 %. Qual das seguintes alternativas é o próximo passo mais adequado na gestão desta doente?",
  ...
  {
    questionText: "Uma mulher de 47 anos, empregada de limpeza, recorre novamente ao seu"+
...
"explique as suas queixas. Qual dos seguintes é o próximo passo mais adequado?",
    answerOptions: [
      { answerText: "Conceder incapacidade temporária para o trabalho até que recupere", isCorrect: false },
      { answerText: "Confrontar a doente com a inconsistência das suas queixas", isCorrect: false },
      { answerText: "Introduzir a possibilidade de causalidade psicológica para os sintomas", isCorrect: true },
      { answerText: "Introduzir medicação anti-inflamatória", isCorrect: false },
      { answerText: "Solicitar exames auxiliares de diagnóstico para tranquilizar a doente", isCorrect: false },
    ],
  },
  {
    questionText: "Um lactente de 4 meses é trazido à consulta de pediatria por má evolução ponderal." +
...
"Qual das seguintes alternativas é a mais adequada para estabelecer o diagnóstico etiológico mais provável?",
    answerOptions: [
      ...
      { answerText: "Exame bacteriológico de secreções respiratórias.", isCorrect: false },
      { answerText: "Exame bacteriológico e parasitológico de fezes", isCorrect: false },
      { answerText: "Prova de suor", isCorrect: true },
      { answerText: "Raio-X do tórax", isCorrect: false },
    ],
  },
{
  questionText: "Um homem de 34 anos, auxiliar de ação médica, vem ao consultório médico para"+
...
"Qual das seguintes alternativas é o próximo passo mais adequado, neste momento?",
  answerOptions: [
    { answerText: "Iniciar terapêutica tripla, com isoniazida, rifampicina e pirazinamida por um ano.", isCorrect: false },
    { answerText: "Prescrever isoniazida e etambutol por um um ano.", isCorrect: false },
    { answerText: "Prescrever isoniazida por seis meses.", isCorrect: false },
    { answerText: "Repetir teste de Mantoux ao fim de um ano.", isCorrect: false },
    { answerText: "Solicitar raio-X do tórax.", isCorrect: true },
  ],
  },
      {
    questionText: "Uma mulher de 36 anos vem ao consultório médico por dificuldade progressiva"+
...
{
  questionText: "Três dias após a admissão hospitalar por politraumatismo na sequência de uma" +
...
"Qual das seguintes alternativas é a causa mais provável para a diminuição do débito urinário?",
  answerOptions: [
    ...
    { answerText: "Hematoma pélvico com obstrução da uretra", isCorrect: false },
  ...
  {
  questionText: "Uma adolescente de 14 anos vem ao consultório médico por exantema pruriginoso" +
...
"encontrar nas lesões desta doente?",
  ...
  {
  questionText: "Um homem de 49 anos, empregado numa livraria, vem à consulta hospitalar para"+
...
{
  questionText: "Numa amostra de 100 indivíduos, a contagem média de leucócitos é de 7500/mm3, com um desvio padrão de 1000/mm3. Se a contagem de leucócitos nesta população seguir uma distribuição normal (gaussiana), aproximadamente 50% dos indivíduos terão qual das seguintes contagens totais de leucócitos?",
  answerOptions: [
...
{
  questionText: "Um homem de 39 anos vem ao médico devido a uma história de 6 meses de progressiva falta de ar. Ele tem tido uma tosse produtiva de expectoração branca há 2 anos. Fumou 1 maço de cigarros diariamente durante 16 anos, mas deixou de fumar há 10 anos. Está em ligeira dificuldade respiratória com lábios com bolsa e peito de barril; está a usar os músculos acessórios da respiração. Os sons respiratórios são distantes e os crepitações estão presentes nos campos pulmonares inferiores bilateralmente. Os testes de função pulmonar mostram uma diminuição da relação VEF1:CVF, aumento do volume residual, e diminuição da capacidade de difusão. Uma radiografia do tórax mostra hiperinsuflação e hipertranslucidez dos lobos inferiores de ambos os pulmões. Qual dos seguintes é o diagnóstico mais provável?",
  answerOptions: [
...
{
  questionText: "É criado um animal experimental no qual os centros germinais dos gânglios linfáticos reactivos mostram encolhimento de células, florescimento citoplasmático, sem inflamação adjacente, e membranas plasmáticas intactas. Estes achados celulares são muito provavelmente causados por qual dos seguintes mecanismos?",
  answerOptions: [
    { answerText: "Activação da caspase", isCorrect: true },
    { answerText: "Diminuição da concentração de citocromo c", isCorrect: false },
    { answerText: "Diminuição da concentração intracelular de Ca2+", isCorrect: false },
    { answerText: "Aumento da actividade de glutatião peroxidase", isCorrect: false },
    { answerText: "Aumento da actividade enzimática lisossomal", isCorrect: false },
  ],
},
{
  questionText: "Os investigadores realizam um estudo que avalia o efeito da finasterida na incidência do cancro da próstata em 500 pacientes. Os investigadores recrutam mais 1000 pacientes para o estudo. Qual dos seguintes efeitos terá isto sobre a investigação estudar?",
  answerOptions: [
